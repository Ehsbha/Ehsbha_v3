<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="contact.aspx.cs" Inherits="Ehsbha_SP.contact" %>
...
<body style="background-color: rgba(215,233, 216,0.5); flex-grow: 0;">
    ...
    <form runat="server">
        ...
        <div style="color: #02614D;" class="form-box">
            <p class="request" >Select your request:</p>
            ...
            &nbsp;
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <label for="title" role="textbox" >Title</label>&nbsp;
                <asp:TextBox ID="title" runat="server" name="title" class="title1" />
            <asp:TextBox ID="subject" name="subject" runat="server" TextMode="multiline" Columns="50" Rows="5" placeholder="Enter your comment here...." Style="height: 150px" />
            <asp:Button runat="server" type="submit" class="submit-btn" OnClick="sendEmail_Click" Text="Submit"  />
        </div>
    </form>
